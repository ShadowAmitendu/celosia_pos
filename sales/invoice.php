...
<div class="print-container bg-white rounded-2xl shadow-lg p-8 md:p-12 max-w-4xl mx-auto">
    ...
    <div class="border-b-2 border-gray-200 pb-6 mb-6">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-sm text-gray-600 font-mono">Illuminating moments since 2024</p>
            </div>
    ...
    <?php if ($sale['customer_name'] || $sale['customer_phone'] || $sale['customer_email']): ?>
        <div class="mb-6 bg-lavender bg-opacity-30 rounded-lg p-4 font-mono">
    ...
    <!-- Totals -->
    <div class="flex justify-end mb-6 font-mono">
    ...
    <!-- Notes -->
    <?php if ($sale['notes']): ?>
        <div class="mb-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded font-mono">

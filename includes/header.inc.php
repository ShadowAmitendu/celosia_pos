...
<nav class="bg-gradient-to-r from-lavender to-pastel-pink shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-3 md:py-4">
            ...
            <?php
            $rootPath = '';
            if (str_contains($_SERVER['PHP_SELF'], '/inventory/') || str_contains($_SERVER['PHP_SELF'], '/sales/')) {
                $rootPath = '../';
            }
            ?>
            <a href="<?php echo $rootPath; ?>index.php"
               class="flex items-center space-x-2 md:space-x-3">
                <div class="bg-white rounded-full p-2 shadow-md md:p-2.5">
                    <svg class="w-8 h-8 md:w-10 md:h-10 text-gold"
                         fill="currentColor"
                         viewBox="0 0 24 24">
                ...
                <div class="text-sm md:text-base">
                    <h1 class="heading-font text-lg md:text-2xl font-bold text-gray-800">CELOSIA CANDLES - POS</h1>
            ...
            <div class="hidden lg:flex items-center space-x-6">
                ...
                <a href="<?php echo $rootPath; ?>sales/new_sale.php"
                   class="bg-gold hover:bg-gold-dark text-white px-4 md:px-6 py-1.5 md:py-2 rounded-full font-semibold transition-colors shadow-md flex items-center space-x-1 md:space-x-2">
        ...
        <!-- Mobile / Tablet Menu -->
        <div id="mobile-menu"
             class="hidden lg:hidden pb-4 space-y-2">
            <a href="<?php echo $rootPath; ?>index.php"

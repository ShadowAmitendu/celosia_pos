...
<?php endif; ?>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
        <form method="GET"
            ...
            <button type="submit"
                    class="bg-gold hover:bg-gold-dark text-white px-6 py-3 rounded-lg font-semibold transition-colors shadow-md flex items-center justify-center space-x-2">
                <svg class="w-5 h-5"
                     fill="none"
                     stroke="currentColor"
                     viewBox="0 0 24 24">
            ...
            <a href="add_item.php"
               class="bg-pastel-pink hover:bg-opacity-80 text-gray-800 px-6 py-3 rounded-lg font-semibold transition-colors shadow-md flex items-center justify-center space-x-2">
                <svg class="w-5 h-5"
                     fill="none"
                     stroke="currentColor"
                     viewBox="0 0 24 24">
...
<?php if (empty($items)): ?>
    <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
        ...
        <a href="add_item.php"
           class="inline-flex items-center space-x-2 bg-gold hover:bg-gold-dark text-white px-6 py-3 rounded-lg font-semibold transition-colors">
            <svg class="w-5 h-5"
                 fill="none"
                 stroke="currentColor"
                 viewBox="0 0 24 24">
